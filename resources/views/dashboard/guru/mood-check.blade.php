...
@section('title', 'Data Mood Check Siswa')
...
@section('content')
  ...
  <div class="px-6 py-6 bg-blue-100 min-h-screen">
    <!-- Header -->
    <div class="mb-6">
      <h1 class="text-2xl font-bold text-[#010E82]">Data Mood Check Siswa</h1>
      <p class="text-gray-600 mt-1">Monitor data mood check siswa Anda</p>
    </div>
    ...
    <div class="filter-card mb-6">
      ...
      <div class="filter-body">
        <form method="GET" action="{{ route('guru.laporan.mood-check') }}">
    ...
    <div class="data-card">
      <div class="data-header">
        <div class="data-title">
          <h2>Hasil Mood Check Siswa</h2>
          <p class="data-subtitle">Menampilkan {{ $moodChecks->total() }} data mood check</p>
        </div>
        <a href="{{ route('guru.laporan.mood-check.export', request()->query()) }}" class="btn-primary">
