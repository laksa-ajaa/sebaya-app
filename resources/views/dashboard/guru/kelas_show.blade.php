...
@section('content')
    <div class="px-6 py-6 bg-blue-100 min-h-screen">
        ...
        <div class="grid grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-[15px] p-6" style="box-shadow: 1px 2px 2px 0px #00000040;">
                <div class="text-center">
                    <p class="text-3xl font-bold text-[#010E82]">{{ $screening_count ?? 0 }}</p>
                    <p class="text-sm text-gray-600 mt-2">Screening</p>
                </div>
            </div>
            <div class="bg-white rounded-[15px] p-6" style="box-shadow: 1px 2px 2px 0px #00000040;">
                <div class="text-center">
                    <p class="text-3xl font-bold text-[#010E82]">{{ $needs_attention ?? 0 }}</p>
                    <p class="text-sm text-gray-600 mt-2">Butuh Perhatian</p>
                </div>
            </div>
            <div class="bg-white rounded-[15px] p-6" style="box-shadow: 1px 2px 2px 0px #00000040;">
                <div class="text-center">
            ...
            <div class="overflow-x-auto rounded-[15px]" style="border: 1px solid #B3b7da; position: relative;">
                <table class="min-w-full" style="border-collapse: separate; border-spacing: 0;">
                    ...
                    <tbody class="bg-white">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <form method="POST" id="verify-form-{{ $s['id'] }}"
                                                ...
                                                <button type="button"
                                                    ...
                                                    onclick="openConfirm('verify', 'verify-form-{{ $s['id'] }}')"
                                                    title="Verifikasi">
                                            ...
                                            <form method="POST" id="reject-form-{{ $s['id'] }}"
                                                ...
                                                <button type="button"
                                                    ...
                                                    onclick="openConfirm('reject', 'reject-form-{{ $s['id'] }}')"
                                                    title="Tolak">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                        fill="currentColor" class="w-5 h-5">
                                                        <path fill-rule="evenodd"
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-4 text-center text-sm text-gray-500">Belum ada siswa
                                    pada kelas ini
                                </td>
                            </tr>
                        @endforelse
