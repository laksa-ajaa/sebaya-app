...
@section('content')
                    ...
                    @forelse($classes as $class)
                        <div class="bg-white rounded-[15px] p-6"
                            ...
                            <div class="grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-gray-200">
                                ...
                                <div class="text-center">
                                    <p class="text-2xl font-bold text-[#010E82]">{{ $class->screening_count ?? 0 }}</p>
                                    <p class="text-xs text-gray-600 mt-1">Screening</p>
                                </div>
                                <div class="text-center">
                                    <p class="text-2xl font-bold text-[#010E82]">{{ $class->needs_attention ?? 0 }}</p>
                    ...
                    <div class="p-6">
                        ...
                        <form method="POST" action="{{ route('guru.kelas.store') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="space-y-3">
                                    <label class="flex items-center">
                                        <input type="radio" name="teacher_option" id="addTeacherOptionNone"
                                            value="none" checked
                                            class="w-4 h-4 text-[#010E82] focus:ring-2 focus:ring-[#010E82]">
                                        <span class="ml-2 text-sm text-gray-700">Tidak ada guru</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="teacher_option" id="addTeacherOptionExisting"
                                            value="existing"
                                            class="w-4 h-4 text-[#010E82] focus:ring-2 focus:ring-[#010E82]">
                                        <span class="ml-2 text-sm text-gray-700">Pilih guru yang ada</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="teacher_option" id="addTeacherOptionNew"
                                            value="new"
                                            class="w-4 h-4 text-[#010E82] focus:ring-2 focus:ring-[#010E82]">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="password" name="new_teacher_password" id="addNewTeacherPassword"
                                            ...
                                            style="border: 1px solid #010E82;">
                                        <button type="button" id="toggleAddPassword"
                                            ...
                                            <span id="eyeSlashIconAdd" class="hidden">
                            ...
                            <div class="flex justify-end gap-3">
                                ...
                                <button type="submit"
                                    class="px-6 py-2 bg-[#010E82] text-white rounded-lg hover:bg-[#0B3BAA]">
                                    Simpan
                                </button>
                            </div>
                        </form>
                ...
                <div class="p-6">
                    ...
                    <form id="editForm" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-3">
                                <label class="flex items-center">
                                    <input type="radio" name="teacher_option" id="editTeacherOptionNone"
                                        value="none" checked
                                        class="w-4 h-4 text-[#010E82] focus:ring-2 focus:ring-[#010E82]">
                                    <span class="ml-2 text-sm text-gray-700">Tidak ada guru</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" name="teacher_option" id="editTeacherOptionExisting"
                                        value="existing" class="w-4 h-4 text-[#010E82] focus:ring-2 focus:ring-[#010E82]">
                                    <span class="ml-2 text-sm text-gray-700">Pilih guru yang ada</span>
                                </label>
                                <label class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button" id="toggleEditPassword"
                                        ...
                                        <span id="eyeSlashIconEdit" class="hidden">
                                            <x-eye-slash-icon color="currentColor" />
                                        </span>
                                    </button>
                                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            setupPasswordToggle('addNewTeacherPassword', 'toggleAddPassword', 'eyeIconAdd', 'eyeSlashIconAdd');
            setupPasswordToggle('editNewTeacherPassword', 'toggleEditPassword', 'eyeIconEdit', 'eyeSlashIconEdit');
        });
    </script>
@endsection
