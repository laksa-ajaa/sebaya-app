...
@section('content')
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      setupPasswordToggle('newAdminPassword', 'toggleNewAdminPassword', 'eyeIconNewAdmin', 'eyeSlashIconNewAdmin');
    });
  </script>
@endsection
