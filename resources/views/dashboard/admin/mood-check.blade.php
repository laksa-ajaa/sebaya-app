                ...
                <form method="GET" action="{{ route('admin.laporan.mood-check') }}">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="end_date" id="endDatePicker" class="input-field"
                                value="{{ $endDate }}" placeholder="Pilih tanggal" readonly>
                        </div>
            ...
            @if ($moodChecks->hasPages())
                <div class="pagination-info">
                    <span class="pagination-text">
                        Menampilkan {{ $moodChecks->firstItem() }} - {{ $moodChecks->lastItem() }} dari
                        {{ $moodChecks->total() }}
                        data
                    </span>
