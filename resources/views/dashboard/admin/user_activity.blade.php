        ...
        <div class="bg-white rounded-[15px] mb-6" style="box-shadow: 1px 2px 2px 0px #00000040; border: 1px solid #B3b7da;">
            ...
            <form method="GET" class="p-6">
                ...
                <div class="flex gap-3 mt-4">
                    ...
                    <a href="{{ route('admin.user-activity.export', request()->query()) }}"
                        class="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors flex items-center justify-center">
                        Export XLSX
                    </a>
                </div>
            </form>
                            ...
                            <tr class="hover:bg-gray-50" style="border-bottom: 1px solid #B3b7da;">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center"
                                    ...
                                    <span
                                        ...
                                        {{ $user->screening_sessions_count ?? 0 }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center"
                                    style="border-right: 1px solid #B3b7da;">
